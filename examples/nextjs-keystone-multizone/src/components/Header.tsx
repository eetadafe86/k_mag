...
import { ADMIN_UI_URL } from '../util/url';
...
export function Header() {
  ...
  if (!user) {
    return (
      <Fragment>
        <div style={{ minHeight: '2rem', display: 'flex', gap: '1em', alignItems: 'flex-end' }}>
          <label>
        ...
        <div style={{ marginTop: '1rem' }}>
          <a href={ADMIN_UI_URL} target="_blank">
            Admin UI
          </a>
        </div>
      </Fragment>
  ...
  return (
    <Fragment>
      <div style={{ minHeight: '2rem', display: 'flex', justifyContent: 'space-between' }}>
